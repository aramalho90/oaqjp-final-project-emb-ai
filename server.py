...
def detect():
    ...
    formatted_response = f"""For the given statement, the system response is 'anger': {response_dict['anger']},
     'disgust': {response_dict['disgust']}, 
     'fear': {response_dict['fear']}, 
     'joy': {response_dict['joy']} and
     'sadness': {response_dict['sadness']}. The dominant emotion is {response_dict['dominant_emotion']}."""
